      ...
      <section className="space-y-8">
        <div className="flex items-center justify-between border-b-2 border-gray-200 pb-4 mb-6">
          <h2 className="text-3xl font-bold text-gray-900 flex items-center gap-3">
            ...
            תעודות שהוזנו
            <span className="text-blue-600 ml-2">({searchQuery ? `${filteredDocuments.length} / ${documents.length}` : documents.length})</span>
          </h2>
        </div>
        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pr-10 pl-4 py-2.5 bg-white border border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-colors"
            />
          </div>
        </div>
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <div className="flex items-end gap-3">
                    ...
                    <button
                      ...
                      className="bg-red-50 text-red-600 hover:bg-red-100 hover:text-red-800 px-4 py-2 rounded-xl font-bold transition-colors flex items-center gap-2"
                    >
